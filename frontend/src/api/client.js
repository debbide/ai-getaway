...
const messageMap = {
  ...
  'redeem code not found': '激活码不存在，请检查后重试',
  'redeem code already used': '该激活码已被使用或已停用',
  'redeem code not unused': '该兑换码当前状态不允许停用',
  'invalid redeem code': '请输入正确的 12 位激活码',
  'redeem code count too large': '单次最多生成 100 个兑换码',
